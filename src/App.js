        ...
        <>
            ...
            <section className="page page2" ref={pages[1]}>
                ...
                <div className="content">
                    ...
                    <p>Ми з командою бачимо проблему онлайн-іміджу ліцею та учнів як частини цієї персони. Бажаємо покращити її шляхом перероблення сайту ліцею та його соціальних сторінок, полегшення зв'язку між учнями. Наші вміння, наприклад, демонструє сторінка, на яку ви дивитеся ;)</p>
